...
var ToastProvider = (props) => {
  ...
  const [toastCount, setToastCount] = React7.useState(0);
  const isFocusedToastEscapeKeyDownRef = React7.useRef(false);
  const isClosePausedRef = React7.useRef(false);
  if (!label.trim()) {
    console.error(
  ...
  return (0, import_jsx_runtime6.jsx)(Collection.Provider, { scope: __scopeToast, children: (0, import_jsx_runtime6.jsx)(
    ToastProviderProvider,
    {
      ...
      onToastAdd: React7.useCallback(() => setToastCount((prevCount) => prevCount + 1), []),
      onToastRemove: React7.useCallback(() => setToastCount((prevCount) => prevCount - 1), []),
...
var ToastViewport = React7.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToast,
    ...
    const headFocusProxyRef = React7.useRef(null);
    const tailFocusProxyRef = React7.useRef(null);
    ...
    const getSortedTabbableCandidates = React7.useCallback(
      ({ tabbingDirection }) => {
...
var FocusProxy = React7.forwardRef(
  (props, forwardedRef) => {
...
var ToastImpl = React7.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToast,
      type = "foreground",
    ...
    const composedRefs = useComposedRefs(forwardedRef, (node2) => setNode(node2));
    const pointerStartRef = React7.useRef(null);
    const swipeDeltaRef = React7.useRef(null);
    const duration = durationProp || context.duration;
    const closeTimerStartTimeRef = React7.useRef(0);
    const closeTimerRemainingTimeRef = React7.useRef(duration);
    const closeTimerRef = React7.useRef(0);
    ...
    const startTimer = React7.useCallback(
      (duration2) => {
    ...
    const announceTextContent = React7.useMemo(() => {
...
var ToastAnnounce = (props) => {
  ...
  const context = useToastProviderContext(TOAST_NAME, __scopeToast);
  const [renderAnnounceText, setRenderAnnounceText] = React7.useState(false);
  const [isAnnounced, setIsAnnounced] = React7.useState(false);
...
var ToastTitle = React7.forwardRef(
  (props, forwardedRef) => {
...
var ToastDescription = React7.forwardRef(
  (props, forwardedRef) => {
...
var ToastAction = React7.forwardRef(
  (props, forwardedRef) => {
...
var ToastClose = React7.forwardRef(
  (props, forwardedRef) => {
...
var ToastAnnounceExclude = React7.forwardRef((props, forwardedRef) => {
